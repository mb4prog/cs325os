...
extern void cat_eat(unsigned int bowlnumber, unsigned int debug);
extern void mouse_eat(unsigned int bowlnumber, unsigned int debug);
	       ...
	       unsigned long catnumber)
{
   ...
   *  eating (by calling cat_eat()) on each iteration */
          ...
          unsigned long mousenumber)
{
   ...
   *  eating (by calling mouse_eat()) on each iteration */
  for(i=0;i<NumLoops;i++) {
